...
plt.pie(sum_values_df['Value'], labels=sum_values_df['Category'], autopct='%1.1f%%', colors=['#213A57','#0B6477','#14919B'], textprops={'fontsize': 20})
...
plt.figure(figsize=(10, 8))
plt.pie(avg_values_df['Value'], labels=avg_values_df['Category'], autopct='%1.1f%%', colors=['#213A57','#0B6477','#14919B'], textprops={'fontsize': 20})
